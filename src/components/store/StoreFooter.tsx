    ...
    <footer className="bg-gradient-to-br from-[#2C3830] via-[#253028] to-[#1E2820] !text-white">
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          {/* Brand */}
          <div>
            <h3 className="text-lg font-semibold mb-4 tracking-wide !text-white">GROHN FABRICS</h3>
            ...
            <div className="flex gap-3">
              <a href="https://twitter.com/grohnfabrics" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors !text-white">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg>
              </a>
              <a href="https://instagram.com/grohnfabrics" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors !text-white">
              ...
              <a href="https://www.etsy.com/shop/AgoraLoom" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors !text-white">
          ...
          {/* Shop */}
          <div>
            <h4 className="text-sm font-semibold mb-4 !text-[#C5D3BE]">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <a href="mailto:grohn@grohn.com.tr" className="text-sm !text-white/60 hover:!text-white transition-colors">
                  grohn@grohn.com.tr
                </a>
              </li>
              <li>
                <a href="tel:+905398802346" className="text-sm !text-white/60 hover:!text-white transition-colors">
                  +90 (539) 880 23 46
                </a>
              </li>
              <li>
                <a href="https://wa.me/905398802346" target="_blank" rel="noopener noreferrer" className="text-sm !text-white/60 hover:!text-[#25D366] transition-colors flex items-center gap-1.5">
              ...
              <li className="!text-white/40 text-sm pt-2">
                Velimeşe OSB, Kervancı Ticaret Merkezi B12, Ergene/Tekirdağ
              </li>
            </ul>
          </div>
        </div>
