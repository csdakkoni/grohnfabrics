...
export default function BeforeAfterSlider({
    ...
    return (
        ...
        >
            {/* Before (left side - bare room) */}
            <div className="absolute inset-0">
                <div className="w-full h-full bg-gradient-to-br from-[#E8E4DB] via-[#D8D4CB] to-[#C8C4BB] flex items-center justify-center">
                    {/* Bare room illustration */}
            ...
            {/* After (right side - with curtains) */}
            <div
                className="absolute inset-0"
                style={{ clipPath: `inset(0 0 0 ${sliderPos}%)` }}
            >
                <div className="w-full h-full bg-gradient-to-br from-[#F2EFE8] via-[#E8E4DB] to-[#DED9D0] flex items-center justify-center">
                    <div className="relative w-full h-full">
                        {/* Wall */}
                        <div className="absolute inset-0 bg-gradient-to-b from-[#F5F1E8] to-[#E8E4DB]" />
                        {/* Floor */}
